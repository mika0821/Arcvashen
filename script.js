...
const translations = {
  hy: {
    ...
    trustEyebrow: "Ինչու ընտրել մեզ",
    trustTitle: "Պարզ հարմարավետություն, հարգալից սպասարկում և ամեն ինչ մեկ վայրում։",
    trustIntro: "Կարճ ներկայացում հյուրերի համար, ովքեր ցանկանում են արագ հասկանալ հիմնական առավելությունները։",
  ...
  ru: {
    ...
    trustEyebrow: "Почему выбирают нас",
    trustTitle: "Простой комфорт, уважительный сервис и всё рядом.",
    trustIntro: "Короткий обзор для гостей, которые хотят быстро понять главные преимущества.",
  ...
  en: {
    ...
    trustEyebrow: "Why guests choose us",
    trustTitle: "Simple comfort, respectful service, and everything close by.",
    trustIntro: "A short overview for guests who want to understand the main benefits quickly.",
